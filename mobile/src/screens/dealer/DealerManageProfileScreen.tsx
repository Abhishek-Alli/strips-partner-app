/**
 * Dealer Manage Profile Screen
 *
 * Profile Edit and Password Setting tabs for dealers
 */
...
const DealerManageProfileScreen: React.FC = () => {
      ...
      <View style={styles.profileHeader}>
        ...
        <View style={styles.profileInfo}>
          ...
          <View style={styles.referralBadge}>
            <Text style={styles.referralText}>Referral Code: 123456</Text>
          </View>
        </View>
      </View>
...
export default DealerManageProfileScreen;

/**
 * Dealer Products Screen (Mobile)
 *
 * Manage product catalogue with add/edit/delete functionality
 */
...
const sampleProducts: Product[] = [
  ...
  },
  {
    ...
    name: 'Acel Switch',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor',
    image: 'https://picsum.photos/200/150?random=75',
    isActive: true,
  },
  {
    id: '7',
    name: 'Acel Switch',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor',
    image: 'https://picsum.photos/200/150?random=76',
    isActive: true,
  },
];

const DealerProductsScreen: React.FC = () => {
  ...
  const handleEditProduct = (product: Product) => {
    ...
    setImages(['https://picsum.photos/100/100?random=80', 'https://picsum.photos/100/100?random=81', 'https://picsum.photos/100/100?random=82', 'https://picsum.photos/100/100?random=83']);
    setVideos(['https://picsum.photos/100/100?random=84', 'https://picsum.photos/100/100?random=85', 'https://picsum.photos/100/100?random=86', 'https://picsum.photos/100/100?random=87']);
